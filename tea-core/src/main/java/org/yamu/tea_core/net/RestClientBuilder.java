...
public class RestClientBuilder {
    ...
    private String mDonwloadDir = null;
    ...
    public final RestClientBuilder loader(Context context) {
        this.mContext = context;
        this.mLoaderStyle = LoaderStyle.PacmanIndicator;
        return this;
    }

    public final RestClient build() {
        return new RestClient(mUrl, PARAMS, mIRequest, mISuccess, mIFailure, mIError, mBody, mFile, mDonwloadDir, mExtension, mName, mContext, mLoaderStyle);
    }
}
